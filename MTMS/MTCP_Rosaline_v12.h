 ...
 *  rev10   10/18/16     add tMTCP_payload_YGTS_REQ for Yogi Fault Condition Test, add tMTCP_payload_YGTR_RSP for current request
...
/*  Calss 1 Eye Compliance Test Response
 *
 *  Direction
 *      Apple Test SW -> Test Controller
 *  Payload
...
typedef struct tMTCP_payload_YGWC_REQ{
	...
	uint8_t PROG0_REG;		//
	uint8_t Y_NVM[17];		// Yogi NVM from 0x13 to 0x23
